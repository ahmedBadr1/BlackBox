        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="{{ route('admin.locations.update',$location->id) }}">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <label for="street" class="col-form-label text-md-right"> @lang("auth.street")</label>
...
{{--                    <div class="form-group row">--}}
{{--                        <label for="latitude" class="col-md-4 col-form-label text-md-right">@lang("auth.latitude")}}</label>--}}
{{--                        <div class="col-md-6">--}}
