            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="hearedAboutUs" class="col-md-4 col-form-label text-md-right">{{ __('auth.hearedAboutUs') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('auth.conpass') }}</label>
