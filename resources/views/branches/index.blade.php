...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                @can('branch-create')
                    <a href="{{route('branches.create')}}" class="btn btn-success">{{__("auth.create")}} {{__("names.branch")}}</a>
                @endcan
                ...
                <table class="table table-hover">
                    ...
                    @foreach($branches as $branch)
                        ...
                        <tr>
                            ...
                            @endcan
                            @can('branch-edit')
                            <td><a href="{{ route('branches.edit',$branch->id) }}" class="btn btn-info">{{__('auth.edit')}}</a></td>
                            @endcan
                            @can('branch-delete')
                            <td>
