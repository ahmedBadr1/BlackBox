                    ...
                    <div class="pl-0">
                        <div class="main-profile-overview">
                            ...
                            @if($allOrders)
                                ...
                                <div class="skill-bar clearfix">
                                    ...
                                    <div class="progress my-2" >
                                            ...
                                            <div class="progress-bar progress-bar-striped bg-success progress-bar-animated " role="progressbar"  style="width: {{($doneOrders / $allOrders) * 100   }}%;height: 24px" aria-valuenow="{{$doneOrders}}" aria-valuemin="0" aria-valuemax="{{$allOrders}}">
                            ...
                            @if($allTasks)
                                ...
                                <div class="skill-bar clearfix">
                                    <span>@lang('names.tasks')</span>
                                    <div class="progress mt-2">
                                            <div class="progress-bar progress-bar-striped bg-success progress-bar-animated " role="progressbar"  style="width: @if((($doneTasks / $allTasks) * 100) > 10  ){{  ($doneTasks / $allTasks) * 100  }}% @else 10% @endif ; height: 24px;" aria-valuenow="{{$doneTasks}}" aria-valuemin="0" aria-valuemax="{{$allTasks}}">
                        ...
                        <div class="card-body">
                            <div class="counter-status d-flex md-mb-0">
                                <div class="counter-icon bg-primary-transparent">
                                    <i class="bx bx-box bx-sm text-primary"></i>
                                </div>
                                <div class="mr-auto">
                                    <h5 class="tx-13">@lang('names.orders')</h5>
                                    <h2 class="mb-0 tx-22 ml-2 mt-1">{{$doneOrders}}</h2>
                                    <p class="text-muted mb-0 tx-11"><i
                                            class="bx bxs-up-arrow-circle text-success mr-1"></i>@lang('names.increase')</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="counter-status d-flex md-mb-0">
                                <div class="counter-icon bg-danger-transparent">
                                    <i class="bx bx-task bx-mf text-danger"></i>
                                </div>
                                <div class="mr-auto">
                                    <h5 class="tx-13">@lang('names.tasks')</h5>
                                    <h2 class="mb-0 tx-22 ml-2 mt-1">{{$doneTasks}}</h2>
                                    <p class="text-muted mb-0 tx-11"><i
                                            class="bx bxs-up-arrow-circle text-success mr-1"></i>@lang('names.increase')</p>
                                </div>
                            </div>
