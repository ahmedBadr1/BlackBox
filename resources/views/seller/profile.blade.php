                        ...
                        <div class="tab-pane active" id="home">
                            <form method="POST" action="{{route('profile.update')}}" enctype="multipart/form-data">
                                ...
                                <div class=" row">
                                    ...
                                    <div class="col-md-8">
                                    <label for="bio" class=" col-form-label text-md-right">{{ __('auth.bio') }}</label>
                                ...
                                <div class=" row">
                                    ...
                                    <div class="col-md-4">
                                    <label for="phone" class=" col-form-label text-md-right">{{ __('auth.phone') }}</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="area" class=" col-form-label text-md-right">{{__('names.area')}}</label>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <label for="url" class=" col-form-label text-md-right">{{__('auth.url')}}</label>
